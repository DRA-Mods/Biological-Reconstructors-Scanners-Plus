...
public class PawnColumnWorker_IsScanned : PawnColumnWorker
{
    ...
    public override bool VisibleCurrently => GetActiveAnimalDatabase.GetDatabase() != null;
    ...
    public static string GetTip(bool? isInDatabase)
    {
        if (isInDatabase == null) 
            return null;
    ...
    public override string GetHeaderTip(PawnTable table) => "BiologicalReconstructors.ScannersPlus.AlphaMemes.JumpToDatabase".Translate();
}